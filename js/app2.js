...
function renderResultados(resultados) {
    ...
    resultados.forEach(res => {
        ...
        for(let i=1; i<=3; i++) {
            ...
            if(ab && ab.Name) {
                // Determinar Categoría revisando la Pokédex original
                let cat = "Básica";
        ...
        // Agregar Forcejeo leyendo desde DB si existe, si no usa un efecto por defecto
        ...
        movesList.forEach(m => {
            let dbText = "N/A";
            // Si hace daño, calculamos los dados y le sumamos el Stat Ofensivo actual
            ...
            // Colores por categoría de movimiento
